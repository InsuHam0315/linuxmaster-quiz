...
- 2023년 12월 09일 리눅스마스터 2급 필기 기출 CBT를 추가했습니다.
- 파일 위치: `cbt/linuxmaster2_20231209.html`, `data/linuxmaster2_20231209.js`
- 문제 수: 80문항
- 정답표 기준: 교사용 PDF 마지막 정답표
- 출처: 전자문제집 CBT
- 기출문제 원문은 `source/` 폴더의 PDF를 참고한다.
